...
`,He=({drinkThumb:e,drinkTitle:n,id:o})=>l.jsxs(Qe,{children:[l.jsx(qe,{src:e,alt:n,onError:r=>{r.currentTarget.src=re}}),l.jsxs(Ge,{children:[l.jsx(Ve,{children:n}),l.jsx(Fe,{to:`/drink/${o}`,children:"See more"})]})]}),Xe=d.ul`
  display: flex;
  flex-direction: row;
  flex-wrap: wrap;
  gap: 28px;
...
`,Ze=d.p`
  color: var(--white-color);
`;function it(){const e=V(),n=j(oe),o=j(ie),r=j(ae),t="",c="",i="",a=1,u=9;return O.useEffect(()=>{e(N({name:t,category:c,ingredient:i,page:a,size:u}))},[e]),l.jsx(ee,{children:l.jsxs(Ye,{children:[l.jsx(te,{title:"Drinks"}),l.jsx(Ae,{}),o?l.jsx("p",{children:"Loading..."}):r||n.length===0?l.jsx(Ze,{children:"No cocktails were found for your request"}):l.jsx(Je,{drinks:n})]})})}export{it as default};
