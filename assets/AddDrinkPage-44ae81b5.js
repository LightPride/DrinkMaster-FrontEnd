import{u as o,c as I,aD as P,r as x,j as e,aE as w,d as M,x as G,aF as H,a9 as $,aa as u,aG as B,aH as U,aI as Y,aJ as L,aK as _,L as J,aL as K,y as Q,z as X,aM as Z,C as V,aN as ee}from"./index-fbe50268.js";import{s as ie,b as ne,S as E,a as te}from"./react-select.esm-53e2d36e.js";import{i as se}from"./drinks.selectors-9842005e.js";import{P as re}from"./PageTitle-2553f705.js";const oe=o.div`
  display: flex;
...
`,Ne=({values:i,errors:n,handleChange:a,touched:c})=>e.jsxs(Se,{children:[e.jsx(De,{children:e.jsx("h4",{children:"Recipe Preparation"})}),e.jsxs(Ie,{children:[e.jsx(w,{as:"textarea",placeholder:"Enter the recipe",name:"instructions",onChange:s=>{a(s)},value:i.instructions,className:`inputField ${n.instructions&&c.instructions&&"inputFieldErr"}`}),n.instructions&&c.instructions&&e.jsx("p",{className:"errorInstructions",children:"this field is mandatory"})]})]}),ze=()=>{const i=M(),[n,a]=x.useState(!1),c=G();return e.jsx(H,{initialValues:{drink:"",ingredients:[{title:"",measure:""}],instructions:"",category:"",glass:"",alcoholic:"Non alcoholic",shortDescription:""},validationSchema:$().shape({drink:u().required("This field is mandatory"),shortDescription:u().required("This field is mandatory"),instructions:u().required("This field is mandatory"),category:u().required("This field is mandatory"),glass:u().required("This field is mandatory"),alcoholic:u().required("Select the type of cocktail"),drinkThumb:B().required("Select image please"),ingredients:U().of($().shape({title:u().required("Ingredient title is required"),measure:u().required("Ingredient measure is required")})).required("At least one ingredient is required")}),onSubmit:async s=>{a(!0);const t=new FormData;t.append("drink",s.drink),t.append("category",s.category),t.append("shortDescription",s.shortDescription),t.append("alcoholic",s.alcoholic),t.append("instructions",s.instructions),t.append("glass",s.glass),t.append("drinkThumb",s.drinkThumb);const h=JSON.stringify(s.ingredients);t.append("ingredients",h);try{const l=await i(Y(t));l.meta.requestStatus==="fulfilled"?(L.Notify.success(l.payload.message+" ,name: "+l.payload.newDrink.drink),L.Notify.info("in 5 seconds you will be redirected to the page with your cocktails"),setTimeout(()=>{a(!1),c("/my")},4e3)):L.Notify.failure(l.payload.message)}catch(l){L.Notify.failure(l),console.error("Error:",l),a(!1)}},children:({values:s,errors:t,touched:h,handleChange:l,handleBlur:m,setFieldValue:b})=>e.jsx(_,{children:e.jsxs(le,{children:[e.jsx(ye,{values:s,errors:t,touched:h,handleChange:l,handleBlur:m,setFieldValue:b}),e.jsx(ve,{values:s,errors:t,touched:h,handleChange:l,handleBlur:m,setFieldValue:b}),e.jsx(Ne,{values:s,errors:t,touched:h,handleChange:l,handleBlur:m}),e.jsx("button",{className:"buttonAdd",type:"submit",disabled:n,children:n?"Loading...":"Add"})]})})})},Ce=o.ul`
  display: flex;
  flex-direction: column;
  gap: 24px;
  a {
