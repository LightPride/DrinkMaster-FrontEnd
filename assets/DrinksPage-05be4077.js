...
`,et=h.p`
  color: var(--white-color);
`;function it(){const e=V(),n=I(ie),o=I(ae),r=I(ce),t="",c="",i="",a=1,s=9;return O.useEffect(()=>{e(C({name:t,category:c,ingredient:i,page:a,size:s}))},[e]),f.jsx(ee,{children:f.jsxs(Ze,{children:[f.jsx(ne,{title:"Drinks"}),f.jsx(Qe,{}),o?f.jsx(te,{}):r||n.length===0?f.jsx(et,{children:"No cocktails were found for your request"}):f.jsx(Ye,{drinks:n})]})})}export{it as default};
