...
`,Me=ee.map(e=>e.categori),ze=te.map(e=>e.title),Ae=({handleChangeFilter:e})=>s.jsxs(We,{children:[s.jsx($e,{id:"filterInput",type:"text",placeholder:"Enter the text",onChange:e,debounceTimeout:1e3}),s.jsx($,{id:"categorySelect",placeholder:"All categories",options:Me}),s.jsx($,{id:"ingredientSelect",placeholder:"Ingredients",options:ze})]}),Ue=Ae,Ve=d.li`
  width: 335px;
...
`,Xe=({drinkThumb:e,drinkTitle:n,id:o})=>s.jsxs(Ve,{children:[s.jsx(qe,{src:e,alt:n,onError:r=>{r.currentTarget.src=ne}}),s.jsxs(He,{children:[s.jsx(Fe,{children:n}),s.jsx(Ge,{to:`/drinks/${o}`,children:"See more"})]})]}),Je=d.ul`
  display: flex;
  flex-direction: row;
  flex-wrap: wrap;
  gap: 28px;
...
`,Qe=({drinks:e})=>s.jsx(Je,{children:e.map(({drink:n,drinkThumb:o,_id:r})=>s.jsx(Xe,{id:r,drinkTitle:n,drinkThumb:o},r))}),Ye=d.div`
  padding-top: 80px;
  padding-bottom: 80px;
...
`,Ze=d.p`
  color: var(--white-color);
`;function it(){const e=ae(),n=T(re),o=T(oe),r=T(ie),t="",c="",i="",a=1,u=9;return V.useEffect(()=>{e(J({name:t,category:c,ingredient:i,page:a,size:u}))},[e]),s.jsx(Q,{children:s.jsxs(Ye,{children:[s.jsx(Y,{title:"Drinks"}),s.jsx(Ue,{}),o?s.jsx("p",{children:"Loading..."}):r?s.jsxs(Ze,{children:["Error: ",r]}):s.jsx(Qe,{drinks:n})]})})}export{it as default};
