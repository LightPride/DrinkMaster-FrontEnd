...
`;let se=(n=21)=>crypto.getRandomValues(new Uint8Array(n)).reduce((e,t)=>(t&=63,t<36?e+=t.toString(36):t<62?e+=(t-26).toString(36).toUpperCase():t>62?e+="-":e+="_",e),"");const ce=({ingredients:n})=>i.jsxs(i.Fragment,{children:[i.jsx(oe,{children:"Ingredients"}),i.jsx(ae,{children:n.map(e=>i.jsx("li",{children:i.jsx(re,{title:e.title,measure:e.measure,quantity:e.quantity,images:e.ingredientThumb})},se()))})]}),S="/DrinkMaster-FrontEnd/assets/coctails@1xMob-773a9476.jpg",de="/DrinkMaster-FrontEnd/assets/coctails@2xMob-fecfc36c.jpg",pe="/DrinkMaster-FrontEnd/assets/coctails@1xTab-650f5580.jpg",le="/DrinkMaster-FrontEnd/assets/coctails@2xTab-ceb1294d.jpg",ue="/DrinkMaster-FrontEnd/assets/coctails@1xDesk-461ecb5e.jpg",he="/DrinkMaster-FrontEnd/assets/coctails@2xDesk-d80c3656.jpg",xe=o.h2`
  color: var(--white-color);
  font-size: 28px;
  font-weight: 600;
  line-height: 1.14;
