import{u as o,c as I,aE as q,r as h,j as e,aF as j,d as M,i as P,aG as G,as as $,at as m,aH as H,aI as B,aJ as U,aK as T,aL as Y,L as _,aM as J,k as K,l as Q,aN as X,C as Z,aO as V}from"./index-b22de4f5.js";import{s as ee,b as ie,S as E,a as ne}from"./react-select.esm-46b84305.js";import{h as te}from"./drinks.selectors-9b8cc722.js";import{P as se}from"./PageTitle-add90d28.js";const re=o.div`
  display: flex;
...
`,Ce=()=>{M();const i=I(te);return e.jsx(ze,{children:i.map(n=>e.jsx("li",{children:e.jsxs(_,{to:`/drinks/${n._id}`,children:[e.jsx("img",{src:n.drinkThumb,alt:n.tags}),e.jsxs("div",{children:[e.jsxs("h4",{children:[n.drink," "]}),e.jsx("p",{children:n.description})]})]})},n._id))})},Me=()=>{const i=M();return h.useEffect(()=>{i(J()),i(K()),i(Q()),i(X())},[i]),e.jsx(Z,{children:e.jsxs(re,{children:[e.jsx(se,{title:"Add drink"}),e.jsxs(oe,{children:[e.jsx(Ne,{}),e.jsxs(ae,{children:[e.jsxs("div",{children:[e.jsx(O,{mb:"20px",children:"Follow Us"}),e.jsx(V,{})]}),e.jsxs("div",{children:[e.jsx(O,{mb:"28px",children:"Popular Drinks"}),e.jsx(Ce,{})]})]})]})]})})};export{Me as default};
